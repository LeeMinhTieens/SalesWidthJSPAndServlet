            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form id ="formLogin">
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="<c:url value='/dang-ky?action=register' />"
	...
	function login(data){
		$.ajax({
			...
			success: function(result){
				if (result.hasOwnProperty("urlResponse")) {
						window.location.href = result.urlResponse;
					} else {
						$('#alertlogin').hide();
						$('#errorSystem').addClass("alert-"+result.alert);
			...
			error: function(error){
				$('#alertlogin').hide();
				$('#errorSystem').addClass("alert-danger");
